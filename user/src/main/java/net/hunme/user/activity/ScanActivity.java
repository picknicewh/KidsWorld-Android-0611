...
import net.hunme.baselibrary.util.ewcode.CameraManager;
import net.hunme.baselibrary.util.ewcode.CameraManager2;
import net.hunme.baselibrary.util.ewcode.DecodeThread;
import net.hunme.baselibrary.util.ewcode.LuminanceSource;
import net.hunme.baselibrary.util.ewcode.PlanarYUVLuminanceSource;
import net.hunme.baselibrary.widget.ScanView;
import net.hunme.user.R;
import net.hunme.user.mode.ScanVo;
...
public class ScanActivity extends Activity implements  CameraManager.PreviewFrameShotListener, SurfaceHolder.Callback, DecodeThread.DecodeListener, OkHttpListener, CameraManager2.PreviewFrameShotListener ,View.OnClickListener{
   ...
   private SurfaceView preView;
    ...
    private void qRCodeConformLogin(String token,String sign){
        ...
        Type type = new TypeToken<net.hunme.baselibrary.mode.Result<String>>(){}.getType();
    ...
    private void scanLogin(String md5,String sign){
        ...
        param.put("requestSource","android");
        param.put("sign",sign);
        Type type = new TypeToken<net.hunme.baselibrary.mode.Result<ScanVo>>(){}.getType();
    ...
    public void onSuccess(String uri, Object date) {
        if (uri.equals(Apiurl.SCANLOGIN)){
            if (date!=null){
                net.hunme.baselibrary.mode.Result<ScanVo> data = (net.hunme.baselibrary.mode.Result<ScanVo>) date;
            ...
            if (date!=null){
                net.hunme.baselibrary.mode.Result<String> data = (net.hunme.baselibrary.mode.Result<String>) date;
