...
public class AlbumAdapter extends BaseAdapter {
    ...
    public AlbumAdapter(Activity act, List<ImageBucket> list) {
        this.act = act;
        dataList = list;
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        if (arg1 == null) {
            holder = new Holder();
            arg1 = View.inflate(act, R.layout.item_select_album_pop, null);
            holder.iv = (ImageView) arg1.findViewById(R.id.iv_album);
            holder.name = (TextView) arg1.findViewById(R.id.tv_album_name);
            holder.count = (TextView) arg1.findViewById(R.id.tv_album_num);
            arg1.setTag(holder);
        } else {
