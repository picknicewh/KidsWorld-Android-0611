...
package net.hunme.baselibrary.util.ewcode;
...
public class PlanarYUVLuminanceSource extends LuminanceSource {
	 ...
	 * @param yuvData
	 *                  YUV数据，包含Y信息和UV信息
	 * @param dataWidth  dataHeight
	 *                  图像大小
	 * @param previewRect
	 *                  要处理的图像区域
	 */
	public PlanarYUVLuminanceSource(byte[] yuvData, int  dataWidth,int  dataHeight, Rect previewRect) {
		super(previewRect.width(), previewRect.height());
		if (previewRect.left + previewRect.width() > dataWidth || previewRect.top + previewRect.height() > dataHeight) {
	...
	public byte[] getRow(int y, byte[] row) {
		...
		int offset = (y + previewRect.top) * dataWidth + previewRect.left;
