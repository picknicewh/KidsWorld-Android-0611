...
public class UserAction {
     ...
     * @param activity
     */
    public static void goShareActivity(Activity activity, String extra) {
        ComponentName componetName = new ComponentName("net.hongzhang.bbhow", "net.hongzhang.bbhow.share.ShareActivity");
        Intent intent = new Intent();
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
