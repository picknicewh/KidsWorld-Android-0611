...
public class MessageDetailActivity extends BaseActivity implements OkHttpListener, View.OnClickListener {
    ...
    private void initview() {
        ...
        if (timeList.size() > 0) {
            if (timeList.size() == 1) {
                long startTime = Long.parseLong(timeList.get(timeList.size() - 1)) - 1000;
                getInforList(String.valueOf(startTime), timeList.get(0));
            } else {
       ...
       // Log.i("TAHHHHG", "==========================" + helper.getcount(db, tsid));
       // Log.i("TAHHHHG", timeList.get(timeList.size() - 1) + "==========================" + timeList.get(0));
    }
    ...
    private void getInforList(String startDate, String endDate) {
        ...
        Type type = new TypeToken<Result<List<StatusInfo>>>() {
        }.getType();
